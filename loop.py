...
def run_autonomous_loop(topic, iterations=1, search_query=None):
    ...
    for i in range(1, iterations + 1):
        ...
        prompt_actor = (
            ...
            f"DO NOT self-limit to a 'representative subset' or an arbitrary number of papers for the sake of keeping the document short or manageable. "
            f"Every single paper that passes the relevance criteria above MUST be integrated, however many that is - there is no maximum.\n"
