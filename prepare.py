...
if __name__ == "__main__":
    ...
    if "--fetch" in sys.argv:
        ...
        # Aggiornato il conteggio dei paper integrati a 18 (15 previous + 4 Mobile Phone)
        score = compute_living_survey_score(integrated_papers_count=18, figure_generated=fig_exists)
